...
<div class="max-w-screen-sm mx-auto p-4">
        ...
        <?php foreach ($data as $task) { ?>
            <li class="p-4 flex flex-col w-full border-b hover:bg-gray-100 transition-colors duration-200">
                ...
                <a
                    ...
                    class="ml-auto p-2 inline-flex items-center text-sm font-semibold text-white leading-tight bg-gray-500 hover:bg-gray-600 rounded-lg transition-all duration-200 transform hover:-translate-y-px hover:shadow-lg"
                >
    ...
    <a
        ...
        class="ml-auto p-4 inline-flex justify-center items-center text-base font-semibold text-white leading-tight text-center w-full bg-green-500 hover:bg-green-600 rounded-lg transition-all duration-200 transform hover:-translate-y-px hover:shadow-lg"
    >
